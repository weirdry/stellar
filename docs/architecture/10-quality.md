...
and remove required files in disposable copies, exclude optional assets, and
verify that metadata-only package edits preserve generated bytes while version
