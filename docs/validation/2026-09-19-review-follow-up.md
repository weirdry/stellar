...
| P3-2: core drift checks lack regression coverage       | The [isolated-copy test](../../test/diagrams.test.js) now rejects source/HTML/SVG drift, manifest drift, orphan HTML/SVG and a missing SVG, checking all copied files for unintended mutation.                                                                                                                   |
| P3-3: unenforced generator and sidecar rules           | The [checker](../../scripts/docs/diagrams.mjs) requires the reviewed generator version, with a rejecting test. Local visual-check receipts and screenshots are ignored by Git.                                                                                                                                   |
...
[browser regression](../../test/browser/diagrams.test.js) waits for actual
